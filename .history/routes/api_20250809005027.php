...
Route::post('/ably/auth', function (Request $request) {
    ...
    // capabilities: admin can access all chat channels, users only their channel
...
// Get messages between two users (current_user_id passed as query param)
...
// Send message: store & publish to receiver's Ably channel
...
Route::get('/users', function () {
    return UserEntry::where('is_admin', false)->get();
});
