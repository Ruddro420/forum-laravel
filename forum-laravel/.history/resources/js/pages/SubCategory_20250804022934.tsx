    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Sub Category', href: '/subcategory' }]}>
            ...
            <div className="p-4 space-y-6">
                ...
                {/* Form */}
                <form onSubmit={handleSubmit} className="space-y-4 max-w-full grid grid-cols-3 items-center gap-4">
                    <div>
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={processing}
                            className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 mt-3"
                        >
